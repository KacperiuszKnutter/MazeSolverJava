...
public class Observers {
    ...
    public class MazePanel extends JPanel implements Observer
    {
        ...
        public void update(MazeData mazeData)
        {
            ...
            coordinatesSetter.addObservers(mazePanel, mazeNavbar, mazeSidePanel);
    ...
    public class MazeSidePanel extends JPanel implements Observer
    {
...

        {
           ...
           setBorder(new EmptyBorder(DEFAULTHEIGHT / 30, 0, DEFAULTHEIGHT / 30, 0));
            ...
            startRowField.setFont(mediumFont);
            startRowField.setForeground(Color.WHITE);

            startColumnField.setFont(mediumFont);
            startColumnField.setForeground(Color.WHITE);

            endRowField.setFont(mediumFont);
            endRowField.setForeground(Color.WHITE);

            endColumnField.setFont(mediumFont);
            endColumnField.setForeground(Color.WHITE);
